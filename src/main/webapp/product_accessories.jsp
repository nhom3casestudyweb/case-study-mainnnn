            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-action">
                        <button type="submit" name="productId" value="${product.productId}"><a
                                href="/product-servlet?action=showProductDetail&productId=${product.productId}"
                                style="text-decoration: none; color: white">Xem chi tiết sản phẩm</a></button>
                    </div>
                </div>
            </div>
        </c:forEach>

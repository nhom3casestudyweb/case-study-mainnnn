    ...
    <table id="user" class="table table-striped table-hover" style="text-align: center">
        ...
        <c:forEach var="customer" items="${customerList}" varStatus="loop">
            <tr>
                ...
                <td>
                    <button style="height: 29px;padding: unset;background: transparent;border: none;margin-top: -1px;"
                            type="submit" class="btn btn-primary text-dark"><a
                            href="customer?action=edit&id=${customer.id}" style="color: black">
                        <i class="fa-solid fa-user-pen"></i>
                    </a></button>
                    <button style="height: 29px;padding: unset;background: transparent;border: none;margin-top: -1px;"
                            type="submit" class="btn btn-primary text-dark" data-bs-toggle="modal"
                            data-bs-target="#exampleModal"
                            onclick="sendInfoToModal('${customer.id}','${customer.name}')">
            ...
            <div class="modal-content">
                <form action="customer?action=delete" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button style="background: grey;height: 43px;width: 77px;" type="submit"
